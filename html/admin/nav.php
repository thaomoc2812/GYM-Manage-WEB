<ul id="main-menu" class="">
    ...
    <li id="dash"><a href="../html/admin/home.html"><i class="entypo-gauge"></i><span>Dashboard</span></a></li>
    ...
    <li class="" id="hassubopen"><a href="#" onclick="memberExpand(1)"><i class="entypo-users"></i><span>Quản lý nhân viên</span></a>
        <ul id="memExpand">
            <li class="active">
    ...
    <li class="" id="planhassubopen"><a href="#" onclick="memberExpand(2)"><i class="entypo-quote"></i><span>Plan</span></a>
        ...
        <ul id="planExpand">
            <li class="active">
                <a href="new_plan.php"><span>New Plan</span></a>
            </li>
