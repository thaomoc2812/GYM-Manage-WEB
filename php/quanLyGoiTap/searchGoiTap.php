      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li><a href="viewGoiTap.php">Xem danh sách gói tập</a></li>
            <li class="active"><a href="../../html/admin/quanLyGoiTap/searchGoiTap.html">Tìm kiếm gói tập</a></li>
            ...
            <form action="searchGoiTap.php" method="post">
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <td><a href="editGoiTap.php?sid=<?php echo $r['id'] ?>" class="btn btn-info">Sửa</a>
                             <a onclick="return confirm('Bạn có muốn xóa trang thiết bị này không?')" href="deleteGoiTap.php?sid=<?php echo $r['id'] ?>" class="btn btn-danger">Xóa</a></td>
                            </tr>
                        <?php
                    }
                ?>
