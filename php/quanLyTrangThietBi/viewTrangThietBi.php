      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="viewTrangThietBi.php">Xem danh sách trang thiết bị</a></li>
            <li><a href="../../html/admin/quanLyTrangThietBi/searchTrangThietBi.html">Tìm kiếm trang thiết bị</a></li>
                    ...
                    while ($r = mysqli_fetch_assoc($result))
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="editTrangThietBi.php?sid=<?php echo $r['id'] ?>" class="btn btn-info">Sửa</a>
                             <a onclick="return confirm('Bạn có muốn xóa trang thiết bị này không?')" href="deleteTrangThietBi.php?sid=<?php echo $r['id'] ?>" class="btn btn-danger">Xóa</a></td>
                        </tr>
                        <?php
                    }
                ?>
