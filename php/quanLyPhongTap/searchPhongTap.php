      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li><a href="viewPhongTap.php">Xem danh sách phòng tập</a></li>
            <li class="active"><a href="../../html/admin/quanLyPhongTap/searchPhongTap.html">Tìm kiếm phòng tập</a></li>
            ...
            <form action="searchPhongTap.php" method="post">
