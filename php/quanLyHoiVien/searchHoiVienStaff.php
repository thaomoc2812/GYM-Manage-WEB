...
<body>
    ...
    <nav class="navbar navbar-default">
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            <li><a href="../../html/staff/quanLyHoiVien/searchHoiVien.html">Thêm hội viên</a></li>
            <li><a href="viewHoiVienStaff.php">Xem danh sách hội viên </a></li>
            <li class="active" ><a href="../../html/staff/quanLyHoiVien/searchHoiVien.html">Tìm kiếm hội viên</a></li>
                    ...
                    <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <a onclick="return confirm('Bạn có muốn xóa hội viên này không?')" href="deleteHoiVienStaff.php?sid=<?php echo $r['id'] ?>" class="btn btn-danger">Xóa</a></td>
                            </tr>
                        <?php
                    }
                ?>
